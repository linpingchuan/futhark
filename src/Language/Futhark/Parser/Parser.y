...
Exp2 :: { UncheckedExp }
     ...
     | Exp2 '...' Exp2           { Range $1 Nothing (ToInclusive $3) (srclocOf $1) }
     | Exp2 '..<' Exp2           { Range $1 Nothing (UpToExclusive $3) (srclocOf $1) }
     | Exp2 '..>' Exp2           { Range $1 Nothing (DownToExclusive $3) (srclocOf $1) }
     | Exp2 '..' Exp2 '...' Exp2 { Range $1 (Just $3) (ToInclusive $5) (srclocOf $1) }
     | Exp2 '..' Exp2 '..<' Exp2 { Range $1 (Just $3) (UpToExclusive $5) (srclocOf $1) }
     | Exp2 '..' Exp2 '..>' Exp2 { Range $1 (Just $3) (DownToExclusive $5) (srclocOf $1) }
